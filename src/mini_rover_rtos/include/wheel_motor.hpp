#ifndef WHEEL_MOTOR_HPP_INCLUDED
#define WHEEL_MOTOR_HPP_INCLUDED
...
public:
  ...
  virtual void react(SetWheelSpeed const &);
  virtual void react(WheelInitialize const &);
