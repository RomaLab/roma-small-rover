...
int main(int argc, char *argv[])
{
    ...
    string filename1 = "/home/roma/roma-small-rover/src/cvtest/data/"+to_string(t) + "data"+to_string(1)+".avi"; 
    string filename2 = "/home/roma/roma-small-rover/src/cvtest/data/"+to_string(t) + "data"+to_string(2)+".avi"; 
    string filename3 = "/home/roma/roma-small-rover/src/cvtest/data/"+to_string(t) + "data"+to_string(3)+".avi"; 
    string filename4 = "/home/roma/roma-small-rover/src/cvtest/data/"+to_string(t) + "data"+to_string(4)+".avi"; 
